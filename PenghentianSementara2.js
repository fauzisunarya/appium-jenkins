...
async function main () {
  ...
  const driver = await remote({
    ...
    capabilities: caps
      ...
      const el6 = await driver.$("accessibility id:Ukuran file maksimal 5 MB");
      await el6.waitForDisplayed({ timeout: 50000 });
      await el6.click();

      // simpan dan lanjutkan
      const SIMPAN = await driver.$("-android uiautomator:new UiSelector().className(\"android.view.View\").instance(18)");
